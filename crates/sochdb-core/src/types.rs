...
/// `t_tx_start` says when sochdb learned it. `superseded_by` is set by
...
pub struct Episode {
    ...
    /// Transaction time — when sochdb learned this fact.
...
pub struct ProcedureStep {
    ...
    /// Tool-specific args, opaque to sochdb. Encoded as JSON-compatible
