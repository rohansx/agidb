//! Typed error model for sochdb-core.
//!
//! Public API surfaces `Result<T, SochError>`. Per the constitution
...
// error matching.
impl From<redb::DatabaseError> for SochError {
    fn from(e: redb::DatabaseError) -> Self {
        SochError::Database(e.to_string())
    }
}

impl From<redb::TransactionError> for SochError {
    fn from(e: redb::TransactionError) -> Self {
        SochError::Transaction(e.to_string())
    }
}

impl From<redb::TableError> for SochError {
    fn from(e: redb::TableError) -> Self {
        SochError::Database(e.to_string())
    }
}

impl From<redb::StorageError> for SochError {
    fn from(e: redb::StorageError) -> Self {
        SochError::Database(e.to_string())
    }
}

impl From<redb::CommitError> for SochError {
